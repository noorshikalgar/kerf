...
// Surfaces
pub fn void() -> Hsla { c(0x000000) }
pub fn abyss() -> Hsla { c(0x0a0a0a) }
pub fn crypt() -> Hsla { c(0x111111) }
pub fn ash() -> Hsla { c(0x1a1a1a) }
pub fn slate() -> Hsla { c(0x222222) }
pub fn line() -> Hsla { c(0x1c1c1c) }
pub fn line_hi() -> Hsla { c(0x2e2e2e) }

// Ink
pub fn bone() -> Hsla { c(0xe8e4dc) }
pub fn body() -> Hsla { c(0xb3aea5) }
pub fn mute() -> Hsla { c(0x7d7870) }
pub fn faint() -> Hsla { c(0x504c47) }

// Meaning
pub fn frost() -> Hsla { c(0xa9c4d9) }
pub fn add_fg() -> Hsla { c(0x8fc49a) }
pub fn add_bg() -> Hsla { c(0x0b1a0f) }
pub fn add_emph() -> Hsla { c(0x163d20) }
pub fn del_fg() -> Hsla { c(0xe0706c) }
pub fn del_bg() -> Hsla { c(0x1f0a0a) }
pub fn del_emph() -> Hsla { c(0x44161a) }
...
pub fn syn_function() -> Hsla { c(0xe8e4dc) }
pub fn syn_type() -> Hsla { c(0xb8c6d1) }
pub fn syn_string() -> Hsla { c(0xa7b89a) }
pub fn syn_number() -> Hsla { c(0xd4a95e) }
pub fn syn_comment() -> Hsla { c(0x6b6760) }
pub fn syn_punct() -> Hsla { c(0x8f8a82) }
